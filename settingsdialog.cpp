    ...
    m_userInterface(new Ui::SettingsDialog), m_actionLockScrolling(actionLockScrolling), m_interfaceSettingsCanBeChanged(true)
{
    ...
    connect(mapColorButtons, static_cast<void(QSignalMapper::*)(QObject*)>(&QSignalMapper::mappedObject),
    [=](QObject *widget){
    ...
    m_userInterface->serialPortInfoListBox->setCompleter(NULL);
    m_userInterface->consoleNewLineAt->setCompleter(NULL);;
    m_userInterface->logNewLineAt->setCompleter(NULL);
...
void SettingsDialog::setAllSettingsSlot(Settings& settings, bool setTabIndex)
{
    ...
    m_userInterface->appFontSizeComboBox->setCurrentText(QString::number(settings.appFontSize));
    ...
    {
        appFontSizeChangedSlot(QString::number( settings.appFontSize));
    }
}
...
void SettingsDialog::updateSettings(bool forceUpdate)
{
    ...
    m_currentSettings.appFontSize = m_userInterface->appFontSizeComboBox->currentText().toInt();
