...
public:
    ...
    Q_INVOKABLE QJSValue field(int i)
    {
        ...
        return qjsEngine(this)->newQObject(field);
    }
    ...
    Q_INVOKABLE QJSValue keyValues(ScriptSqlRecord* keyFields)
    {
        ...
        return qjsEngine(this)->newQObject(record);
    }
...
public:
    ...
    Q_INVOKABLE QJSValue lastError()
    {
        ...
        return qjsEngine(this)->newQObject(error);
    }
    ...
    //TODO: change to StriptMap
    Q_INVOKABLE QVariantList boundValues() {return m_query.boundValues();} //{return ScriptMap(m_query.boundValues());}
...
public:
    ...
    Q_INVOKABLE QJSValue primaryIndex(QString tablename)
    {
        ...
        return qjsEngine(this)->newQObject(index);
    }
