...
#include "scriptXml.h"
#if defined(ENABLE_JS_DEBUGGER)
#include <QJSEngineDebugger>
#endif
...
ScriptThread::ScriptThread(ScriptWindow* scriptWindow, quint32 sendId, QString scriptName, QWidget *scriptUi,
    ...
    m_standardDialogs(0), m_scriptFileObject(0), m_isSuspendedByDebuger(false), 
#if defined(ENABLE_JS_DEBUGGER)
    m_debugger(0), 
#endif
    m_debugWindow(0), m_hasMainWindowGuiElements(false),
...
void ScriptThread::setApplicationFontSize(quint32 fontSizePx)
{
    ...
    if(settings.appFontSize != fontSizePx)
    {
        settings.appFontSize = (fontSizePx);
        emit setAllSettingsSignal(settings, false);
    }
}
...
void ScriptThread::run()
{
    try
    {
        ...
        if(m_scriptRunsInDebugger)
        {
            m_debugger = new QJSEngineDebugger(this);
            ...
            m_debugger->action(QJSEngineDebugger::InterruptAction)->trigger();
            ...
            {//A stylesheet was applied.
                ...
                //has to be adjusted.
                QWidget* widget = m_debugger->widget(QJSEngineDebugger::LocalsWidget);
        ...
        if (loadScript(m_scriptFileName, false))
        {
            ...
            else
            {
                ...
                {//In stopScript an error has been occured.
                    ...
                    m_scriptFileObject->showExceptionInMessageBox(m_scriptEngine->catchError(), m_scriptFileName, m_scriptEngine, parent, m_scriptWindow);
                }
            }
