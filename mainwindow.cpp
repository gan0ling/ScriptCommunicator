            ...
            else
            {
...

                {
                    ...
                    if(!nodeList.isEmpty())
                    {
                        ...
                        {
                            currentSettings.appFontSize = node.attributes().namedItem("appFontSize").nodeValue().toInt();
                        }
                        else
                        {
                        ...
                        setStyleSlot(currentSettings.useDarkStyle, currentSettings.appFontSize);
    ...
    {//The current tab has a console.
        ...
        if(!tmpFileName.isEmpty())
        {
            ...
            if(isHtml)
            {
                ...
                //TODO: remove??
                consoleContent.replace(QChar(160), ' ');
