...
public:
    ...
    Q_INVOKABLE void addRexpExValidator(QString pattern, bool caseSensitiv){addValidator(new QRegularExpressionValidator(QRegularExpression(pattern, caseSensitiv ? QRegularExpression::NoPatternOption : QRegularExpression::CaseInsensitiveOption)));}
